...
Visit My webiste / Scan QR code: [https://www.bekalutadesse.com/](https://www.bekalutadesse.com/) <p align="left"> <img src="./img/new_qr.png" alt="qrCode" width="75"/></p>
...
### 🔥 I'm interested in:
- Industrial Automation, programming PLC controllers & Raspberry Pi
- observability RT Dashboards with MQTT + Grafana + TimeSeries DB + MongoDB 
- Data Engineering & Automation
- AWS Cloud Solutions & Automation 
